    ...
    this.floatingPopup.innerHTML = `
      ...
      ">
        <div style="display: flex; align-items: center; gap: 8px;">
          ...
          <span style="font-size: 14px; font-weight: 600;">Voice Navigator</span>
        </div>
      ...
      <div id="voice-nav-content" style="padding: 16px;">
        <div style="display: flex; flex-direction: column; gap: 12px; margin-bottom: 16px;">
          ...
          ">
            <span style="font-size: 16px;">🎤</span>
            <span id="voice-nav-btn-text">Start Listening</span>
          </button>
        ...
        <div id="voice-nav-commands" style="
          ...
          display: none;
        ">
          <h3 style="margin: 0 0 10px 0; font-size: 14px; font-weight: 600;">Available Commands:</h3>
          <ul style="margin: 0; padding-left: 15px; font-size: 11px; line-height: 1.5;">
            <li style="margin-bottom: 3px; opacity: 0.9;"><strong>Navigation:</strong> "scroll up/down", "scroll to top/bottom"</li>
            <li style="margin-bottom: 3px; opacity: 0.9;"><strong>Clicking:</strong> "click [button/link text]"</li>
            <li style="margin-bottom: 3px; opacity: 0.9;"><strong>Typing:</strong> "type [text] into [field name]"</li>
            <li style="margin-bottom: 3px; opacity: 0.9;"><strong>Dropdowns:</strong> "select [option] from [dropdown name]"</li>
            <li style="margin-bottom: 3px; opacity: 0.9;"><strong>Links:</strong> "go to [link text]", "open [URL]"</li>
            <li style="margin-bottom: 3px; opacity: 0.9;"><strong>Forms:</strong> "submit form", "clear field [name]"</li>
            <li style="margin-bottom: 3px; opacity: 0.9;"><strong>Focus:</strong> "focus [field name]"</li>
          </ul>
        </div>
      </div>
    `;
  ...
  setupFloatingPopupEvents() {
    ...
    header.addEventListener('touchend', (e) => {
      ...
      if (tapLength < 500 && tapLength > 0) {
        ...
        this.floatingPopup.style.width = isMinimized ? '280px' : 'auto';
        e.preventDefault();
      }
      lastTap = currentTime;
    });
